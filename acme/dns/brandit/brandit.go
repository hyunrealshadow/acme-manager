...
// Code from https://github.com/go-acme/lego/tree/v4.19.2/providers/dns/brandit
// License: MIT
...
const JsonSchema = "{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Brandit Configuration\",\"type\":\"object\",\"properties\":{\"credentials\":{\"apiUsername\":{\"type\":\"string\",\"description\":\"The API username\"},\"apiKey\":{\"type\":\"string\",\"description\":\"The API key\"}},\"additional\":{\"httpTimeout\":{\"type\":\"string\",\"description\":\"API request timeout\"},\"pollingInterval\":{\"type\":\"string\",\"description\":\"Time between DNS propagation check\"},\"propagationTimeout\":{\"type\":\"string\",\"description\":\"Maximum waiting time for DNS propagation\"},\"ttl\":{\"type\":\"string\",\"description\":\"The TTL of the TXT record used for the DNS challenge\"}}}}"

var compiledJsonSchema *jsonschema.Schema

var credentialsFields = mapset.NewSet("apiUsername", "apiKey")
...
func init() {
	...
	if err != nil {
		logger.Fatalf("Failed to unmarshal brandit JSON schema: %v", err)
	}
	compiler := jsonschema.NewCompiler()
	if err := compiler.AddResource("schema.json", schema); err != nil {
		logger.Fatalf("Failed to add brandit schema resource to compiler: %v", err)
	}
	compiledJsonSchema, err = compiler.Compile("schema.json")
	if err != nil {
		logger.Fatalf("Failed to compile brandit schema: %v", err)
	}
}
...
func ParseConfig(conf *lego.DnsProviderConfig) (*lego.Env, error) {
	...
	if err := compiledJsonSchema.Validate(anyData); err != nil {
		return nil, fmt.Errorf("brandit: configuration validation failed: %v", err)
	}
...
func NewConfig(env lego.Env) *brandit.Config {
	return &brandit.Config{
...
func NewDNSProvider(env lego.Env) (*brandit.DNSProvider, error) {
	...
	return brandit.NewDNSProviderConfig(config)
}
