// Code from https://github.com/go-acme/lego/tree/v4.17.4/providers/dns/oraclecloud
// License: MIT
...
func newConfigProvider(env lego.Env, values map[string]string) *configProvider {
