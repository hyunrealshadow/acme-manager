...
// Code from https://github.com/go-acme/lego/tree/v4.19.2/providers/dns/plesk
// License: MIT
...
const (
	...
	EnvServerBaseURL      = "serverBaseUrl"
	EnvTTL                = "ttl"
	EnvUsername           = "username"
)

const JsonSchema = "{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"plesk.com Configuration\",\"type\":\"object\",\"properties\":{\"credentials\":{\"serverBaseUrl\":{\"type\":\"string\",\"description\":\"Base URL of the server (ex: https://plesk.myserver.com:8443)\"},\"username\":{\"type\":\"string\",\"description\":\"API username\"},\"password\":{\"type\":\"string\",\"description\":\"API password\"}},\"additional\":{\"pollingInterval\":{\"type\":\"string\",\"description\":\"Time between DNS propagation check\"},\"propagationTimeout\":{\"type\":\"string\",\"description\":\"Maximum waiting time for DNS propagation\"},\"ttl\":{\"type\":\"string\",\"description\":\"The TTL of the TXT record used for the DNS challenge\"},\"httpTimeout\":{\"type\":\"string\",\"description\":\"API request timeout\"}}}}"

var compiledJsonSchema *jsonschema.Schema

var credentialsFields = mapset.NewSet("serverBaseUrl", "username", "password")
...
func init() {
	...
	if err != nil {
		logger.Fatalf("Failed to unmarshal plesk JSON schema: %v", err)
	}
	compiler := jsonschema.NewCompiler()
	if err := compiler.AddResource("schema.json", schema); err != nil {
		logger.Fatalf("Failed to add plesk schema resource to compiler: %v", err)
	}
	compiledJsonSchema, err = compiler.Compile("schema.json")
	if err != nil {
		logger.Fatalf("Failed to compile plesk schema: %v", err)
	}
}
...
func ParseConfig(conf *lego.DnsProviderConfig) (*lego.Env, error) {
	...
	if err := compiledJsonSchema.Validate(anyData); err != nil {
		return nil, fmt.Errorf("plesk: configuration validation failed: %v", err)
	}
...
func NewConfig(env lego.Env) *plesk.Config {
	return &plesk.Config{
...
func NewDNSProvider(env lego.Env) (*plesk.DNSProvider, error) {
	...
	return plesk.NewDNSProviderConfig(config)
}
