...
// Code from https://github.com/go-acme/lego/tree/v4.19.2/providers/dns/porkbun
// License: MIT
...
const (
	...
	EnvSecretAPIKey       = "secretApiKey"
	EnvTTL                = "ttl"
	minTTL                = 300
)

const JsonSchema = "{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Porkbun Configuration\",\"type\":\"object\",\"properties\":{\"credentials\":{\"secretApiKey\":{\"type\":\"string\",\"description\":\"secret API key\"},\"apiKey\":{\"type\":\"string\",\"description\":\"API key\"}},\"additional\":{\"pollingInterval\":{\"type\":\"string\",\"description\":\"Time between DNS propagation check\"},\"propagationTimeout\":{\"type\":\"string\",\"description\":\"Maximum waiting time for DNS propagation\"},\"ttl\":{\"type\":\"string\",\"description\":\"The TTL of the TXT record used for the DNS challenge\"},\"httpTimeout\":{\"type\":\"string\",\"description\":\"API request timeout\"}}}}"

var compiledJsonSchema *jsonschema.Schema

var credentialsFields = mapset.NewSet("secretApiKey", "apiKey")
...
func init() {
	...
	if err != nil {
		logger.Fatalf("Failed to unmarshal porkbun JSON schema: %v", err)
	}
	compiler := jsonschema.NewCompiler()
	if err := compiler.AddResource("schema.json", schema); err != nil {
		logger.Fatalf("Failed to add porkbun schema resource to compiler: %v", err)
	}
	compiledJsonSchema, err = compiler.Compile("schema.json")
	if err != nil {
		logger.Fatalf("Failed to compile porkbun schema: %v", err)
	}
}
...
func ParseConfig(conf *lego.DnsProviderConfig) (*lego.Env, error) {
	...
	if err := compiledJsonSchema.Validate(anyData); err != nil {
		return nil, fmt.Errorf("porkbun: configuration validation failed: %v", err)
	}
...
func NewConfig(env lego.Env) *porkbun.Config {
	return &porkbun.Config{
...
func NewDNSProvider(env lego.Env) (*porkbun.DNSProvider, error) {
