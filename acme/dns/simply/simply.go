...
// Code from https://github.com/go-acme/lego/tree/v4.19.2/providers/dns/simply
// License: MIT
...
const JsonSchema = "{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Simply.com Configuration\",\"type\":\"object\",\"properties\":{\"credentials\":{\"accountName\":{\"type\":\"string\",\"description\":\"Account name\"},\"apiKey\":{\"type\":\"string\",\"description\":\"API key\"}},\"additional\":{\"pollingInterval\":{\"type\":\"string\",\"description\":\"Time between DNS propagation check\"},\"propagationTimeout\":{\"type\":\"string\",\"description\":\"Maximum waiting time for DNS propagation\"},\"ttl\":{\"type\":\"string\",\"description\":\"The TTL of the TXT record used for the DNS challenge\"},\"httpTimeout\":{\"type\":\"string\",\"description\":\"API request timeout\"}}}}"

var compiledJsonSchema *jsonschema.Schema

var credentialsFields = mapset.NewSet("accountName", "apiKey")
...
func init() {
	...
	if err != nil {
		logger.Fatalf("Failed to unmarshal simply JSON schema: %v", err)
	}
	compiler := jsonschema.NewCompiler()
	if err := compiler.AddResource("schema.json", schema); err != nil {
		logger.Fatalf("Failed to add simply schema resource to compiler: %v", err)
	}
	compiledJsonSchema, err = compiler.Compile("schema.json")
	if err != nil {
		logger.Fatalf("Failed to compile simply schema: %v", err)
	}
}
...
func ParseConfig(conf *lego.DnsProviderConfig) (*lego.Env, error) {
	...
	if err := compiledJsonSchema.Validate(anyData); err != nil {
		return nil, fmt.Errorf("simply: configuration validation failed: %v", err)
	}
...
func NewConfig(env lego.Env) *simply.Config {
	return &simply.Config{
...
func NewDNSProvider(env lego.Env) (*simply.DNSProvider, error) {
	...
	return simply.NewDNSProviderConfig(config)
}
